...
urlpatterns = [
    ...
    # Login via POST — la contraseña nunca viaja en la URL
    path('get_credentials/', csrf_exempt(views_user.Get_Credentials.as_view()), name="get_credentials"),
    ...
    path('get_one_task/<int:taskId>/', views_management.Get_One_Task.as_view(), name="get_one_task"),
    ...
    path('share_table/', csrf_exempt(views_management.Share_Table.as_view()), name="share_table"),
    path('get_shared_tables/<int:userId>/', views_management.Get_Shared_tables.as_view(), name="get_shared_tables"),

    path('get_comments/<int:taskId>/', views_management.Get_Comments.as_view(), name="get_comments"),
    path('create_comment/', csrf_exempt(views_management.Create_Comment.as_view()), name="create_comment"),
    path('delete_comment/<int:commentId>/', csrf_exempt(views_management.Delete_Comment.as_view()), name="delete_comment"),
]
